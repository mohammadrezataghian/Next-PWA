...
const Content = () => {
  ...
  return (
    <>
      <div className="w-full h-auto 2xl:px-64 xl:px-36 lg:px-5 md:px-14 sm:px-1 xs:px-16 px-3 pt-10 pb-10">
        <div className="w-full h-auto pb-10">
          <h1 className="ring-1 w-48 flex justify-center py-3 ring-blue-950 text-blue-950 rounded-sm">موقعیت های اخیر</h1>
        </div>
        <div className="w-full h-auto flex flex-wrap gap-5 bg-blue-950 justify-center py-5">
          {results && results.map((item)=>(
            <Card key={item.id} sx={{ minWidth: 180,maxWidth:300 }} variant="outlined">
            <CardContent>
